...
export default function SignupForm({ invite, prefillEmail }: SignupFormProps) {
    ...
    <>
      <div className="mb-6 text-center">
        <h1 className="text-xl font-bold" style={{ color: "var(--text-primary)" }}>
          {invite ? "Join the workspace" : "Create an account"}
        </h1>
        <p className="mt-1 text-sm" style={{ color: "var(--text-secondary)" }}>
          {invite ? "Create your account to accept the invitation" : "Start building in under a minute"}
        </p>
      </div>
